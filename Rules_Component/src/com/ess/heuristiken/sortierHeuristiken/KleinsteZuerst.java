 ...
 *
 */
public class KleinsteZuerst implements ISortierHeuristik {

	@Override
	public List<IFliesenTyp> sortiereMittelsHeuristik(List<IFliesenTyp> fliesen, IFlaecheK flache, Point einfuegePunkt, int fugenlaenge) {
