 ...
 * IParserWriter. Ein Singelton bekommt man über die Klassenmethode
 * getInstance(String).
 * 
...
public class XMLParser implements IParserReader, IParserWriter {
	...
	/**
	 * Factory Methode um an eine Instanz des XMLParsers zu gelangen. Für jede
	...
	/**
	 * XML wird geparst und als Document zurückgegeben
	 * 
	 * @param xmlFile
	...
	private Document getDocument(File xmlFile) throws Exception {
		// Die xml wird anhand der DTD gepüft
	 ...
	 *            enthaltene gelöscht, ansonsten wird ganz normal in die Datei
	 *            geschrieben
	 */
	@Override
	...
	/**
	 * Gibt zurück ob der Parser einen Verlegungsplan hat.
	 * 
	 * @return true wenn die xml einen gültigen Verlegungsplan enthält
	 */
